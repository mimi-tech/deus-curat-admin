const String helloTag = 'Welcome to Deus curat Admin, Please login!';
const String dashboard = 'dashboard';
const String needy = 'needy';
const String newRequest = 'New request';
const String allRequest = 'All request';
...
const String deleteTooltip = 'If you delete this request, it will not be retrived again';
