...
class HighestDonors extends ConsumerStatefulWidget {
    HighestDonors({Key? key,required this.donors,
    ...
    return Column(
      ...
      children: [
        Wrap(
          ...
          children: [
            SizedBox(
              width: Responsive.isDesktop(context)?width * 0.5:width,
        ...
        Wrap(
          ...
          children: [
            ...
            CardWidget(title:"Request Count",amount:widget.requestCount,onTap: (){
              ref.read(screenTypeProvider.notifier).state = allRequest;
            },),
            CardWidget(title:"No Of Users",amount:widget.usersCount,onTap: (){
...
class DataSource extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(Text(row.valueA,style: theme.displayLarge!.copyWith(color: kBlackColor))),
        DataCell(Text(row.valueB,style: theme.displayLarge!.copyWith(color: kGreenColor))),
        DataCell(Text(row.valueC,style: theme.displayLarge!.copyWith(color: kYellow),)),
        ...
        DataCell(Text(DateFormat("EEEE, dd,MMM, yyyy h:ma").format(DateTime.parse(row.valueF)),style: theme.displayLarge!.copyWith(color: kDarkRedColor),)),
      ],
    );
  }
